...
TOOLS = [
 ...
 {"type":"function","function":{"name":"evaluate_entitlement","description":"Use for cancellation fees/eligibility or failed-pickup/SLA credits. An order ID is optional when the user names a customer and supplies scenario facts; the server resolves the authorized matching order and performs deterministic math.","parameters":{"type":"object","properties":{"order_id":{"type":["string","null"]},"account_id":{"type":["string","null"]},"customer_name":{"type":["string","null"]},"evaluation_type":{"type":"string","enum":["cancellation","service_credit"]},"reported_pickup_at":{"type":["string","null"]},"booking_age_hours":{"type":["number","null"]},"delay_hours":{"type":["number","null"]},"carrier_fault":{"type":["boolean","null"]},"customer_fault":{"type":["boolean","null"]}},"required":["evaluation_type"]}}},
