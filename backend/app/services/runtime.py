...
class Runtime:
    def __init__(self):
        ...
        self.dataset_now=wb["dataset_now"]; self.docs=docs; self.repo=Repository(SQLITE_PATH,self.dataset_now); self.documents=DocumentTool(docs,CHROMA_DIR); self.actions=ActionTool(ACTION_PATH); self.analytics=AnalyticsTool(self.repo)
